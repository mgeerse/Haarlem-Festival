...
namespace HaarlemFestival_Web.Controllers
{
    public class DashboardController : Controller
    {
        ...
        JazzRepository jazzRepo = JazzRepository.Instance;
        DiningRepository diningRepo = DiningRepository.Instance;
        WalkingRepository walkingRepo = WalkingRepository.Instance;
        ...
        public ActionResult CreateActivity(int i = 0)
        {
            ...
            switch (subjectId)
            {
                //Jazz
                case 5:
                    Jazz jazz = new Jazz { Name = name, Description = description, Capacity = capacity, Price = price, StartTime = startTime, EndTime = endTime, LocationId = 21, SubjectId = subjectId};
                    activityRepo.Insert(jazz);
                    break;

                //Talking
                case 6:
                    Talking talking = new Talking { Name = name, Description = description, Capacity = capacity, Price = price, StartTime = startTime, EndTime = endTime, LocationId = 22, SubjectId = subjectId };
                ...
                //Dining
                case 8:
                    Dining dining = new Dining { Name = name, Description = description, Capacity = capacity, Price = price, StartTime = startTime, EndTime = endTime, LocationId = 23, SubjectId = subjectId };
